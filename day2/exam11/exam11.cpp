    ...
    case WM_PAINT:
        {
			...
			//명함 바탕
			HPEN myPen, oldPen;
			myPen = CreatePen(PS_SOLID, 10, RGB(125, 225, 0));
			oldPen = (HPEN)SelectObject(hdc, myPen);

			HBRUSH myBrush, oldBrush;
			myBrush = CreateSolidBrush(RGB(165, 255, 0));
			oldBrush = (HBRUSH)SelectObject(hdc, myBrush);

			Rectangle(hdc, 100, 100, 600, 300);
			...
			//명함 이름칸
			myPen = CreatePen(PS_SOLID, 10, RGB(225, 125, 0));
			oldPen = (HPEN)SelectObject(hdc, myPen);

			myBrush = CreateSolidBrush(RGB(255, 165, 0));
			oldBrush = (HBRUSH)SelectObject(hdc, myBrush);

			Rectangle(hdc, 330, 200, 100, 100);
			...
			myFont = CreateFont(60, 0, 0, 0, 0, 0, 0, 0, HANGUL_CHARSET, 0, 0, 0, 0, L"궁서");
			...
			TextOut(hdc, 135, 220, L"연락처 : 010 9602 5846", 19);
			TextOut(hdc, 135, 250, L"이메일 : killabee7102@naver.com", 28);
