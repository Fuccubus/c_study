    ...
    case WM_PAINT:
        {
			...
			Font fontGulim(&fontfamGulim,24,FontStyleRegular,UnitPixel);

			SolidBrush brushBlue(Color(0, 0, 255));
			SolidBrush brushBlack(Color(0, 0, 0));

			graphics.DrawString(L"안녕하세요", -1, &fontGulim, PointF(100, 100), &brushBlue);

			graphics.DrawString(L"반가와요", -1, &fontGulim, PointF(100, 100 + 24), &brushBlack);
