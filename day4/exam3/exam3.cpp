    ...
    case WM_PAINT:
        {
			...
			SolidBrush brushGreen(Color(0,255,0));
			SolidBrush brushBlue(Color(0, 0, 255));
			
			graphics.FillRectangle(&brushGreen, 100, 100, 200, 200);
			graphics.DrawRectangle(&penRed, 100, 100, 200, 200);

			graphics.FillEllipse(&brushBlue, 100, 300, 200, 200);
			graphics.DrawEllipse(&penGreen, 100, 300, 200, 200);
