...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		CreateWindow(L"button", L"click Me", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			20, 20, 100, 25, hWnd, (HMENU)1004, hInst, NULL);

		CreateWindow(L"button", L"click Me Too", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			20, 50, 100, 25, hWnd, (HMENU)2004, hInst, NULL);
    ...
    case WM_COMMAND:
        {
				...
				OutputDebugString(L"Button Clicked! \n");
			{
				...
				break;
			case 2004:
				MessageBox(hWnd,L"두번째 버튼을 클릭!", L"메시지 상자", MB_OK);
				break;
