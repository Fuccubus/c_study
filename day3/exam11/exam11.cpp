...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	static HWND hRBtn4, hRBtn5, hRBtn6;

    switch (message)
    {
	case WM_CREATE:
	{
		hRBtn1 = CreateWindow(L"Button", L"Red",
			WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
			10, 20, 100, 30,
			hWnd, (HMENU)6001, hInst, NULL
		);
		hRBtn2 = CreateWindow(L"Button", L"Green",
			WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
			10, 40, 100, 30,
			hWnd, (HMENU)6002, hInst, NULL
		);
		hRBtn3 = CreateWindow(L"Button", L"Blue",
			WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
			10, 60, 100, 30,
			hWnd, (HMENU)6003, hInst, NULL
		);
		...
		hRBtn4 = CreateWindow(L"Button", L"원",
			WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
			200, 20, 100, 30,
			hWnd, (HMENU)6011, hInst, NULL
		);
		hRBtn5 = CreateWindow(L"Button", L"사각",
			WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
			200, 40, 100, 30,
			hWnd, (HMENU)6012, hInst, NULL
		);
		hRBtn6 = CreateWindow(L"Button", L"선",
			WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON,
			200, 60, 100, 30,
