...
{
	static HWND hList;
	TCHAR szListItem[][16] = { L"바나나", L"블루베리", L"포도", L"사과", L"망고", L"딸기", L"참외", L"코코넛", L"수박", L"멜론", L"두리안", L"망고스틴"};
	...
	case WM_CREATE:
		...
		SendMessage(hList, LB_ADDSTRING, 0, (LPARAM)szListItem[5]);
		SendMessage(hList, LB_ADDSTRING, 0, (LPARAM)szListItem[6]);
		SendMessage(hList, LB_ADDSTRING, 0, (LPARAM)szListItem[7]);
		SendMessage(hList, LB_ADDSTRING, 0, (LPARAM)szListItem[8]);
		SendMessage(hList, LB_ADDSTRING, 0, (LPARAM)szListItem[9]);
		SendMessage(hList, LB_ADDSTRING, 0, (LPARAM)szListItem[10]);
		SendMessage(hList, LB_ADDSTRING, 0, (LPARAM)szListItem[11]);
    ...
    case WM_COMMAND:
        {
			...
			case 5001:
			{
				...
				case LBN_SELCHANGE :
					OutputDebugString(L"your Seletion has been Changed! \n");
					{
